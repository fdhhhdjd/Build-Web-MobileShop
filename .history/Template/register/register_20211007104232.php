            ...
            <div class="col-lg-4 offset-lg-2">
                ...
                <div class="d-flex justify-content-center">
                    <form action="register.php" method="post" enctype="multipart/form-data" id="reg-form">
                        <div class="form-row">
                            <div class="col">
                                <input type="text" value="firstName" name="firstName" id="firstName" class="form-control" placeholder="First Name"/>
                            </div>
                            <div class="col">
                        ...
                        <div class="form-row my-4">
                            <div class="col">
                                <input type="email" value="email" required  id="email" class="form-control" placeholder="Email*">
                            </div>
                        </div>
