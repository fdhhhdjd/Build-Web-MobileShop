        ...
        <table class="table table-hover" id="data-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?= $row['item_id']; ?></td>
              <td>
                <a href="detailsCart.php?details=<?= $row['item_id']; ?>" class="badge badge-primary p-2">Details</a> |
                <a href="actionCart.php?delete=<?= $row['item_id']; ?>" class="badge badge-danger p-2" onclick="return confirm('Do you want delete this record?');">Delete</a> |
                <a href="cart.php?edit=<?= $row['item_id']; ?>" class="badge badge-success p-2">Edit</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
